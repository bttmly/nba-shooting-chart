# This is a Web Worker which processes shooting data.
  ...
  if typeof WorkerGlobalScope isnt 'undefined' and self instanceof WorkerGlobalScope
    ...
    self.addEventListener "message", ( event ) ->
      ...
      if event.data.cmd is "stop"
        ...
        makeLeagueAverageBins( event.data.msg )
  ...
  getJSON = ( url, success, fail ) ->
    ...
    request.onerror = ->
      throw new Error "AJAX request to #{ url } couldn't reach the server."
    request.send( data )

  makeLeagueAverageBins = ( msg ) ->

    getJSON msg.ajaxData, ( data ) ->
        ...
        threshold = msg.attThreshold or 1
